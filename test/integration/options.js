...
module.exports = {
  noOptions: function (createFn, setup, dismantle) {
    describe('no options', () => {
      let app = createFn()
  ...
  defaults: function (createFn, setup, dismantle) {
  ...
  totalCountHeader: function (createFn, setup, dismantle) {
  ...
  totalCountHeader2: function (createFn, setup, dismantle) {
  ...
  totalCountHeaderString: function (createFn, setup, dismantle) {
  ...
  limit: function (createFn, setup, dismantle) {
    describe('limit', () => {
      let app = createFn()
      let router = app.koaRouter || app
      let server
  ...
  name: function (createFn, setup, dismantle) {
    describe('name', () => {
      let app = createFn()
      let router = app.koaRouter || app
      let server
  ...
  prefix: function (createFn, setup, dismantle) {
    describe('prefix', () => {
      let app = createFn()
      let router = app.koaRouter || app
      let server
  ...
  version: function (createFn, setup, dismantle) {
    describe('version v8', () => {
      let app = createFn()
      let router = app.koaRouter || app
      let server
  ...
  versionCustom: function (createFn, setup, dismantle) {
    describe('version custom id location', () => {
      let app = createFn()
      let router = app.koaRouter || app
      let server
      let customer
  ...
  defaults2: function (createFn, setup, dismantle) {
  ...
  defaults3: function (createFn, setup, dismantle) {
  ...
  idProperty: function (createFn, setup, dismantle) {
    describe('idProperty', () => {
      let app = createFn()
      let router = app.koaRouter || app
      let server
  ...
  allowRegex: function (createFn, setup, dismantle) {
    describe('allowRegex', () => {
      let app = createFn()
      let router = app.koaRouter || app
      let server
